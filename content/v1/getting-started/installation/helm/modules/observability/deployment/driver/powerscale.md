...
4. Copy only the deployed CSI driver entities to the Observability namespace
    ...
    If [Container Storage Modules for Authorization is enabled](v1/getting-started/installation/helm/modules/authorizationv2#configuring-a-dell-csi-driver-with-container-storage-module-for-authorization) for CSI PowerScale, perform these steps:
