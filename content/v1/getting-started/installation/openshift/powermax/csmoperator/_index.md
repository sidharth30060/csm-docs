...
5. **Create a CR (Custom Resource)** for PowerMax using the sample files provided
    ...
    b. **Detailed Configuration:** Use the [sample file](https://github.com/dell/csm-operator/blob/main/samples/storage_csm_powermax_{{< version-v1 key="Det_sample_operator_pmax" >}}.yaml) for detailed settings.

> NOTE:
> [Replication module](https://github.com/dell/csm-operator/blob/main/samples/storage_csm_powermax_{{< version-v1 key="sample_sc_pmax" >}}.yaml#L283) must be enabled to use the Metro volume
...
```yaml
    - name: replication
      enabled: true
```
>  [Target clusterID](https://github.com/dell/csm-operator/blob/main/samples/storage_csm_powermax_{{< version-v1 key="sample_sc_pmax" >}}.yaml#L316) should be set as self
...
{{< collapse id="1" title="Parameters">}}
  ...
  powermax    3h             powermax        {{< version-v1 key="PMax_latestVersion" >}}         Succeeded      
  ```
