...
- If enabling CSM for Authorization, please refer to the [Authorization deployment steps](v1/getting-started/installation/helm/modules/authorizationv2/) first
...
| **authorization** | [Authorization](./csm-modules/authorizationv2/) is an optional feature to apply credential shielding of the backend PowerFlex. | - | - |
