...
CRDs should be configured during replication prepare stage with repctl as described in [install-repctl](v1/getting-started/installation/helm/modules/replication/install-repctl) 
